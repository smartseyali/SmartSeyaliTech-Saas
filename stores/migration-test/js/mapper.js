export const mapper = {
    ...
    formatPriceParts(amount) {
        const str = Number(amount).toFixed(2);
        const [int, dec] = str.split('.');
        return `<span class="price-symbol" style="font-size: 0.6em; margin-top: 0.2em; align-self: flex-start;"></span>
                <span class="price-whole">${parseInt(int).toLocaleString('en-IN')}</span>
                <span class="price-decimal" style="font-size: 0.6em; margin-top: 0.2em; align-self: flex-start;">${dec}</span>`;
    },
