/**
 * Meridian University — Runtime-configurable Smartseyali template (university-modern).
...
(function () {
  ...
  const DEFAULTS = {
    ...
    companyId: 0,
    storeName: "Meridian University",
    storeTagline: "A modern campus rooted in tradition",
  };
