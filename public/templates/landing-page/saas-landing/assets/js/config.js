/**
 * SaaS Landing — Runtime-configurable Smartseyali template.
 * Reads config from URL query params; falls back to DEFAULTS when standalone.
 */
(function () {
  ...
  const DEFAULTS = {
    ...
    companyId: 0,
    storeName: 'Your Product',
    storeTagline: 'Built for modern teams',
