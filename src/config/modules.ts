...
export const PLATFORM_MODULES: PlatformModule[] = [
    ...
    // ── OPERATIONS & PROJECTS ──────────────────────────────────
    {
        ...
        tagline: 'Manage complex delivery cycles',
        description: 'Track projects, milestones, tasks, and timesheets with advanced resource allocation.',
        icon: '🏗️',
        color: '#7C3AED',
        colorFrom: 'from-violet-600',
        colorTo: 'to-indigo-800',
        route: '/apps/projects',
        dashboardRoute: '/apps/projects',
        category: 'operations',
        status: 'beta',
        includedInPlans: ['professional', 'enterprise', 'custom'],
        isCore: false,
        features: ['Gantt & Kanban Views', 'Task Management', 'Timesheets', 'Milestone Tracking'],
        needsTemplate: false,
    },
    ...
    // ── GOVERNANCE & AUTOMATION ────────────────────────────────
    {
        ...
        tagline: 'Automate business protocols',
        description: 'Design multi-level approval workflows and transition rules for all system documents.',
        icon: '⛓️',
        color: '#0D9488',
        colorFrom: 'from-teal-600',
        colorTo: 'to-emerald-800',
        route: '/apps/workflow',
        dashboardRoute: '/apps/workflow',
        category: 'operations',
        status: 'beta',
        includedInPlans: ['enterprise', 'custom'],
        isCore: false,
        features: ['Approval Matrix', 'Transition Rules', 'Notification Triggers'],
        needsTemplate: false,
    },
    {
        id: 'documents',
        ...
        description: 'Secure document storage with version control, folder hierarchy, and shared access.',
        icon: '📁',
        color: '#64748B',
        colorFrom: 'from-slate-500',
        colorTo: 'to-slate-700',
        route: '/apps/documents',
        dashboardRoute: '/apps/documents',
        category: 'collaboration',
        status: 'live',
        includedInPlans: ['standard', 'professional', 'enterprise', 'custom'],
        isCore: false,
        features: ['Version History', 'Shared Folders', 'Audit Logs', 'Attachment Support'],
        needsTemplate: false,
    },
    {
        id: 'automation',
        name: 'Automation & Jobs',
        tagline: 'Schedule platform tasks',
        description: 'Background job scheduler for recurring reports, data sync, and maintenance tasks.',
        icon: '⚡',
        color: '#EA580C',
        colorFrom: 'from-orange-600',
        colorTo: 'to-rose-800',
        route: '/apps/automation',
        dashboardRoute: '/apps/automation',
        category: 'operations',
        status: 'beta',
        includedInPlans: ['enterprise', 'custom'],
        isCore: false,
        features: ['Job Scheduling', 'Execution Logs', 'Trigger Matrix'],
        needsTemplate: false,
    },
    {
        id: 'reports_module', // using id to avoid conflict with existing reports
        name: 'Enterprise Reports',
        tagline: 'Clinical Business Intelligence',
        description: 'Advanced query builder and dashboard widgets for deep operational analysis.',
        icon: '📊',
        color: '#2563EB',
        colorFrom: 'from-blue-600',
        colorTo: 'to-indigo-800',
        route: '/apps/reports',
        dashboardRoute: '/apps/reports',
        category: 'analytics',
        status: 'beta',
        includedInPlans: ['professional', 'enterprise', 'custom'],
        isCore: false,
        features: ['Query Builder', 'Dashboard Widgets', 'Scheduled Reports', 'Data Exports'],
        needsTemplate: false,
    },
];
