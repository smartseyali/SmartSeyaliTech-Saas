...
export const PLATFORM_MODULES: PlatformModule[] = [
    ...
    // ── CORE FOUNDATION (MASTER REGISTRY) ──────────────────────
    {
        id: 'masters',
        name: 'Master Registry',
        tagline: 'Core Foundation Engine',
        description: 'Manage all foundational master data including companies, items, contacts, and financial configurations common to all modules.',
        icon: '🏛️',
        color: '#1E293B',
    ...
    },
    {
        id: 'uom_master',
        name: 'UOM Protocols',
        tagline: 'Dimension Normalization Hub',
        description: 'Universal measurement infrastructure for clinical governance of unit identities and conversion ratio protocols.',
        icon: '📏',
        color: '#6366F1',
        colorFrom: 'from-indigo-500',
        colorTo: 'to-blue-700',
        route: '/apps/masters/uoms',
        dashboardRoute: '/apps/masters/uoms',
        category: 'operations',
        status: 'live',
        includedInPlans: ['standard', 'professional', 'enterprise', 'custom'],
        isCore: true,
    ...
    {
        id: 'attribute_registry',
        name: 'Attribute Matrix',
        tagline: 'Variation Identity Protocols',
        description: 'Sophisticated catalog variation system for governing product characteristics and visualization nodes.',
        icon: '🏷️',
        color: '#F59E0B',
        colorFrom: 'from-amber-400',
        colorTo: 'to-orange-600',
        route: '/apps/masters/attributes',
        dashboardRoute: '/apps/masters/attributes',
        category: 'commerce',
        status: 'live',
        includedInPlans: ['standard', 'professional', 'enterprise', 'custom'],
        isCore: true,
        features: [
            'Visual Swatch Swapping',
            'Attribute Value Clusters',
            'Dropdown Logic Packs',
        ],
        needsTemplate: false,
    },
    {
        ...
        tagline: 'Corporate Label Registry',
        description: 'High-fidelity management of corporate brand entities and sub-brand identity hierarchies.',
        icon: '🚩',
        color: '#475569',
        colorFrom: 'from-slate-600',
        colorTo: 'to-slate-800',
        route: '/apps/masters/brands',
        dashboardRoute: '/apps/masters/brands',
        category: 'commerce',
        status: 'live',
        includedInPlans: ['standard', 'professional', 'enterprise', 'custom'],
        isCore: true,
    ...
    },
    {
        ...
        tagline: 'SKU Logic & Item Extensions',
        description: 'Clinical orchestration of product configurations, SKU identity nodes, and systemic stock tracking.',
        icon: '🧬',
        color: '#4F46E5',
        colorFrom: 'from-indigo-600',
        colorTo: 'to-violet-800',
        route: '/apps/masters/variants',
        dashboardRoute: '/apps/masters/variants',
        category: 'commerce',
        status: 'live',
        includedInPlans: ['standard', 'professional', 'enterprise', 'custom'],
        isCore: true,
    ...
    },
    {
        ...
        tagline: 'Consumer Trust Governance',
        description: 'Authorization and moderation hub for consumer narratives, ratings, and trust identity verification.',
        icon: '⭐',
        color: '#EAB308',
        colorFrom: 'from-yellow-400',
        colorTo: 'to-amber-500',
        route: '/apps/masters/reviews',
        dashboardRoute: '/apps/masters/reviews',
        category: 'commerce',
        status: 'live',
        includedInPlans: ['standard', 'professional', 'enterprise', 'custom'],
        isCore: true,
