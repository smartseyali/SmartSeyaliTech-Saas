            ...
            {status === "success" && (
                <div className="text-center py-20 bg-emerald-50 rounded-2xl border border-emerald-200 space-y-5">
                    ...
                    <div className="flex gap-3 justify-center">
                        ...
                        <Button onClick={() => navigate("/ecommerce/masters/products")} className="h-10 px-6 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-bold">View Catalog</Button>
                    </div>
                </div>
            )}
