            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 pb-10 border-b border-slate-100">
                <div className="space-y-3">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-slate-500">Healthcare Management System</span>
                    </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                ...
                <div className="lg:col-span-8 bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden h-fit">
                    <div className="px-8 py-6 border-b border-slate-50 flex items-center justify-between bg-white relative">
                        ...
                        <h2 className="text-[11px] font-black uppercase tracking-[0.2em] text-slate-400">Treatment Pipeline</h2>
                        <Button variant="ghost" className="text-rose-600 text-[10px] font-black uppercase tracking-widest h-8">All Records <ChevronRight className="w-3 h-3 ml-1" /></Button>
                    </div>
                                ...
                                <tr key={pat.id} className="group hover:bg-slate-50/30 transition-all">
                                    ...
                                    <td className="px-8 py-5">
                                        <div className="flex flex-col">
                                            <span className="text-[11px] font-bold text-slate-700 group-hover:text-rose-600 transition-colors uppercase italic leading-none mb-1">{pat.name}</span>
                                            <span className="text-[9px] font-bold text-slate-400 font-outfit uppercase tracking-widest leading-none">{pat.dept}</span>
                                        </div>
                                    </td>
                                    ...
                                    <td className="px-8 py-5 text-right text-[10px] font-bold text-slate-400 uppercase tracking-tighter">{pat.time}</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
                ...
                <div className="lg:col-span-4 space-y-8">
                    <div className="bg-slate-900 rounded-3xl p-8 text-white relative overflow-hidden group">
                        ...
                        <h3 className="text-[10px] font-black uppercase tracking-[0.3em] text-rose-500 mb-6 border-b border-white/5 pb-4 leading-none font-outfit">Critical Alert</h3>
                        <div className="space-y-6 relative z-10">
                            <div className="p-4 rounded-xl bg-white/5 border border-white/5 group-hover:border-rose-500/30 transition-all font-sans">
                                <p className="text-[11px] font-bold text-white mb-2 italic tracking-tight">O2 Supply Status</p>
                                <p className="text-[9px] text-white/40 leading-relaxed font-medium uppercase tracking-wide">Central oxygen levels at 84%. Backup tanks are optimized for 48 hours of emergency supply.</p>
                            </div>
                    ...
                    <div className="bg-white rounded-2xl border border-slate-100 p-8 shadow-sm">
                        <h3 className="text-sm font-black uppercase tracking-[0.2em] text-slate-400 mb-8 border-b border-slate-50 pb-4 leading-none font-outfit">Medical Console</h3>
