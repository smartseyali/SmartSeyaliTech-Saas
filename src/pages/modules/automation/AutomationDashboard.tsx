            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 pb-10 border-b border-slate-100">
                <div className="space-y-4">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-xs font-bold  tracking-widest text-slate-400">Enterprise Orchestrator</span>
                    </div>
                    <h1 className="text-4xl font-bold tracking-tight text-slate-900  ">Automation Hub</h1>
                ...
                <div className="flex gap-4">
                    {AUTOMATION_STATS.map((stat, i) => (
                        <div key={i} className="p-6 bg-white border border-slate-100 rounded-[2rem] shadow-sm flex flex-col items-center text-center min-w-[160px]">
                            ...
                            <span className="text-[9px] font-bold text-slate-400  tracking-widest mt-1">{stat.label}</span>
                            <span className="text-[8px] font-bold text-indigo-500  tracking-widest mt-2">{stat.trend}</span>
                        </div>
                    ))}
                </div>
            </div>
                ...
                {AUTOMATION_NODES.map((sector, idx) => (
                    <div key={idx} className="space-y-6">
                        <div className="flex items-center gap-4">
                            ...
                            <h2 className="text-[11px] font-bold  tracking-widest text-slate-400">{sector.title}</h2>
                        </div>
                                ...
                                >
                                    <div className="flex items-center gap-6">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-[11px] font-medium text-slate-400 mt-2  tracking-widest">{node.desc}</p>
                                        </div>
                                    </div>
                ...
                <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-8">
                    <div className="space-y-3">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-[10px] font-bold  tracking-widest text-indigo-300">Cluster Identity: NODE-ALPHA-01</span>
                        </div>
                        <h4 className="text-2xl font-bold   tracking-tight">System Orchestration Active</h4>
                        <p className="text-xs text-indigo-200/60 font-medium  tracking-widest">Next systemic synchronization cycle: T - 04:12m</p>
                    </div>
                    <div className="flex gap-4">
                        <button className="px-8 py-4 bg-white text-indigo-950 hover:bg-indigo-50 rounded-2xl text-[10px] font-bold  tracking-widest transition-all shadow-xl shadow-white/5">
