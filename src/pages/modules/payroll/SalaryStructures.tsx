...
export default function SalaryStructures() {
    ...
    const { data: items, loading, fetchItems, createItem, updateItem } = useCrud("payroll_structures");
    ...
    if (view === "form") {
        return (
            <div className="p-8 animate-in fade-in slide-in-from-bottom-5 duration-500">
                <ERPEntryForm
                    title={editingItem ? "Edit Compensation Structures" : "New Compensation Structures"}
