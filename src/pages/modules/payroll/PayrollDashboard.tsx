            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 pb-10 border-b border-slate-100">
                <div className="space-y-3">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-[10px] font-bold  tracking-widest text-slate-500">Compensation Management</span>
                    </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                    ...
                    <div key={k.label} className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm hover:border-sky-100 transition-all group">
                        ...
                        <p className="text-[10px] font-bold text-slate-400  tracking-widest mt-1">{k.sub}</p>
                    </div>
                ))}
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                ...
                <div className="lg:col-span-2 bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden h-fit">
                    <div className="p-6 border-b border-slate-50 flex items-center justify-between">
                        <h2 className="text-[11px] font-bold  tracking-widest text-slate-400">Payroll History</h2>
                        <Button variant="ghost" className="text-sky-600 text-[10px] font-bold  tracking-widest h-8">All Cycles <ChevronRight className="w-3 h-3 ml-1" /></Button>
                    </div>
                        ...
                        <tbody className="divide-y divide-slate-50">
                            {recentPayouts.map(pay => (
                                <tr key={pay.id} className="group hover:bg-slate-50/20 transition-all">
                                    ...
                                    <td className="px-6 py-5 text-[11px] font-medium text-slate-500">{pay.cycle}</td>
                                    <td className="px-6 py-5 text-[11px] font-bold text-slate-900">{pay.employees} Users</td>
                                    <td className="px-6 py-5 text-[11px] font-bold text-sky-600">{fmt(pay.amount)}</td>
                                    <td className="px-6 py-5 text-right">
                                        <span className={cn(
                                            "px-2.5 py-1 rounded text-[8px] font-bold  tracking-widest border",
                ...
                <div className="space-y-6">
                    <div className="bg-slate-900 rounded-3xl p-8 text-white relative overflow-hidden group">
                        ...
                        <h3 className="text-[10px] font-bold  tracking-widest text-sky-400 mb-6 border-b border-white/5 pb-4 leading-none">Payroll Engine</h3>
                        <div className="space-y-6 relative z-10">
                            <div className="p-4 rounded-xl bg-white/5 border border-white/5 group-hover:border-sky-500/30 transition-all">
                                <p className="text-[11px] font-bold text-white mb-2">Auto-Sync Enabled</p>
                            ...
                            <Button className="w-full h-11 bg-white/5 hover:bg-white/10 border-white/10 text-white font-bold  tracking-widest text-[9px] rounded-xl transition-all">
                                Tax Configurations
                            </Button>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-2xl border border-slate-100 p-8 shadow-sm">
                        <h3 className="text-sm font-bold  tracking-widest text-slate-400 mb-6 border-b border-slate-50 pb-4 leading-none">Quick Access</h3>
