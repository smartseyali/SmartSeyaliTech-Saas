        ...
        { 
            ...
            render: (row: any) => (
                <div className="flex flex-col">
                    ...
                    <span className="text-[10px] text-gray-400 font-bold uppercase tracking-widest mt-1">{row.category || "General"} / REGISTERED</span>
                </div>
            )
        },
        { 
        ...
        { 
            ...
            render: (row: any) => (
                <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-[11px] font-black text-slate-900 tracking-tight">{row.rating || "0.0"}</span>
                </div>
            )
        },
        { 
        ...
        <ERPListView
            ...
            headerActions={
                <div className="flex items-center gap-2">
                    <button onClick={() => { setEditingVendor(null); setView("form"); }} className="h-8 px-4 rounded-xl font-black text-[10px] uppercase tracking-widest bg-rose-50 text-rose-600 border border-rose-100 hover:bg-rose-100 transition-all flex items-center gap-2 shadow-sm">
                        <Building2 className="w-3.5 h-3.5" /> Enlist Supplier
                    </button>
                    <button className="h-8 px-4 rounded-xl font-black text-[10px] uppercase tracking-widest bg-slate-50 text-slate-600 border border-slate-200 hover:bg-slate-100 transition-all shadow-sm">
                        Matrix Export
                    </button>
                </div>
            }
