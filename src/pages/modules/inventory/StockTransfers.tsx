...
export default function StockTransfers() {
    ...
    const { data: items, loading, fetchItems, createItem, updateItem } = useCrud("inventory_transfers");
    ...
    if (view === "form") {
        return (
            <div className="p-8 animate-in fade-in slide-in-from-bottom-5 duration-500">
                <ERPEntryForm
                    title={editingItem ? "Edit Warehouse Transfers" : "New Warehouse Transfers"}
