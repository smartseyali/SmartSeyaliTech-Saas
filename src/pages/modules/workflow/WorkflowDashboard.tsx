            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 pb-10 border-b border-slate-100">
                <div className="space-y-4">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-xs font-black uppercase tracking-[0.4em] text-slate-400">Governance Engine</span>
                    </div>
                    <h1 className="text-4xl font-bold tracking-tight text-slate-900 uppercase italic">Workflow Control</h1>
                ...
                <div className="flex gap-4">
                    {WORKFLOW_STATS.map((stat, i) => (
                        <div key={i} className="p-6 bg-white border border-slate-100 rounded-[2rem] shadow-sm flex flex-col items-center text-center min-w-[160px]">
                            ...
                            <span className="text-[8px] font-black text-emerald-500 uppercase tracking-widest mt-2">{stat.trend}</span>
                        </div>
                    ))}
                </div>
            </div>
                ...
                <div className="relative z-10 flex items-center justify-between">
                    <div className="space-y-2">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-[10px] font-black uppercase tracking-[0.4em] text-slate-400">Live Transition Feed</span>
                        </div>
                        <h4 className="text-xl font-bold uppercase italic">System State Metrics</h4>
                    </div>
