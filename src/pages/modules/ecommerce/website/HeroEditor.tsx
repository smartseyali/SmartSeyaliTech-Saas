        ...
        <section className="bg-white border rounded-[32px] p-6 md:p-10 shadow-sm relative overflow-hidden group">
            ...
            <div className="flex flex-col md:flex-row md:items-start justify-between mb-12 gap-6 pb-8 border-b border-border">
                <div className="space-y-3">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-[#14532d]/40 font-bold  tracking-widest text-xs">Home Page Header</span>
                    </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
                ...
                <div className="lg:col-span-4 space-y-8">
                    ...
                    <div className="grid grid-cols-1 gap-6">
                        <div className="space-y-2">
                            <label className="text-xs font-bold  tracking-widest text-[#14532d]/40 ml-1">Main Heading</label>
                            <input
                                value={banner?.title || ""}
                        ...
                        <div className="space-y-2">
                            <label className="text-xs font-bold  tracking-widest text-[#14532d]/40 ml-1">Subtext / Description</label>
                            <input
                        ...
                        <div className="space-y-2">
                            <label className="text-xs font-bold  tracking-widest text-[#14532d]/40 ml-1">Badge Label</label>
                            <input
                ...
                <div className="lg:col-span-8">
                    <label className="text-xs font-bold  tracking-widest text-[#14532d]/40 ml-1 mb-2 block">Live Rendering Manifest</label>
                    <div className="relative aspect-[16/9] bg-[#f8fafc] rounded-[32px] border border-border shadow-2xl overflow-hidden group/viz">
                        ...
                        <div className="absolute inset-0 bg-[#0a2e18]/40 p-8 md:p-16 flex flex-col justify-end">
                            <div className="max-w-xl space-y-6">
                                {banner?.badge_text && (
                                    <span className="text-xs font-bold  tracking-widest text-white bg-[#f97316] w-fit px-4 py-1.5 rounded-full shadow-lg shadow-[#f97316]/20">
                                        {banner.badge_text}
                                    </span>
                                )}
