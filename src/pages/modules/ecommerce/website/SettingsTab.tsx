    ...
    if (!settings || connectorLoading) {
        return (
            <div className="flex flex-col items-center justify-center p-32">
                ...
                <p className="text-sm font-bold text-[#14532d]/40 uppercase tracking-[0.2em] mt-8">Loading Identity Settings...</p>
            </div>
        );
    }
            ...
            <div className="lg:col-span-8 space-y-8">
                <section className="bg-white border rounded-[24px] p-8 md:p-12 shadow-sm relative overflow-hidden">
                    <div className="flex items-center gap-3 mb-10 border-b border-slate-50 pb-8">
                        ...
                        <div>
                            <h2 className="text-2xl font-black text-[#14532d] leading-none">Brand Identity</h2>
                            <p className="text-xs font-semibold text-slate-400 mt-1 uppercase tracking-wider">Configure your store's visual manifest</p>
                        </div>
                    </div>
                            ...
                            .map((field) => {
                                ...
                                return (
                                    <div key={field.id} className="space-y-3">
                                        <label className="text-xs font-bold text-[#14532d]/60 uppercase tracking-widest ml-1">{field.label}</label>
                                        <input
                                            value={settings[field.id] || ""}
            ...
            <div className="lg:col-span-4 space-y-8">
                ...
                <section className="bg-[#14532d] rounded-[24px] p-8 text-white shadow-xl relative overflow-hidden group">
                    ...
                    <div className="flex items-center gap-3 mb-8">
                        ...
                        <h2 className="text-xl font-black tracking-tight leading-none uppercase">Store Theme</h2>
                    </div>

                    <div className="space-y-8 relative z-10">
                        <div className="space-y-4">
                            <span className="text-[10px] font-bold uppercase tracking-widest text-white/40 block">Primary Brand Color</span>
                            <div className="flex items-center gap-4">
                                ...
                                <div className="flex-1 space-y-2">
                                    <label className="text-[9px] font-bold uppercase tracking-[0.2em] text-white/30 italic">HEX VALUE</label>
                                    <input
                                        type="text"
                                        value={settings.primary_color || "#14532d"}
                                        onChange={(e) => handleChange("primary_color", e.target.value)}
                                        className="w-full h-10 px-4 bg-white/10 border border-white/10 rounded-lg outline-none font-mono text-xs font-bold uppercase tracking-widest text-white shadow-inner focus:bg-white/20 transition-all"
                                    />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="p-5 bg-white/5 rounded-2xl border border-white/10 space-y-3 relative overflow-hidden">
                            <h4 className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest text-white/60">
                ...
                <section className="bg-white border rounded-[24px] p-8 shadow-sm space-y-6">
                    <div className="flex items-center gap-3">
                        ...
                        <h3 className="text-[11px] font-black uppercase tracking-widest text-[#14532d]">System Status</h3>
                    </div>
                    <div className="space-y-4">
                        <div className="flex justify-between items-center border-b border-slate-50 pb-3">
                            <span className="text-[10px] font-bold text-slate-400 uppercase">Schema Sync</span>
                            <span className="text-[10px] font-black text-[#14532d] uppercase">Enabled</span>
                        </div>
                        <div className="flex justify-between items-center border-b border-slate-50 pb-3">
                            <span className="text-[10px] font-bold text-slate-400 uppercase">Live Preview</span>
                            <span className="text-[10px] font-black text-[#14532d] uppercase">Active</span>
                        </div>
                    </div>
                </section>
            </div>
