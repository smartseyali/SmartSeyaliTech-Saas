...
export function PagesTab({ companyId }: { companyId: any }) {
    ...
    // Derived fields from config if available, otherwise fallback
        ...
        <div className="bg-white border rounded-[32px] p-8 md:p-12 shadow-sm animate-in slide-in-from-bottom-4 duration-500 font-sans relative overflow-hidden group">
            ...
            <div className="flex flex-col md:flex-row md:items-start justify-between mb-16 gap-10 border-b border-slate-50 pb-10">
                <div className="space-y-4">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-[#14532d]/40 font-bold uppercase tracking-widest text-[10px]">Content Management</span>
                    </div>
                    <h2 className="text-4xl md:text-5xl font-black tracking-tight text-[#14532d] leading-none">Storefront <span className="text-slate-100 italic">Pages</span></h2>
                ...
                <div className="flex flex-col md:items-end gap-6">
                    ...
                    <div className="flex items-center gap-2 px-4 py-2 bg-[#f8fafc] rounded-full border border-border shadow-inner">
                        ...
                        <span className="text-[10px] font-bold text-[#14532d]/60 uppercase tracking-widest">Global CDN Active</span>
                    </div>
                </div>
            </div>
            ...
            <div className="overflow-x-auto scrollbar-hide">
                <table className="w-full text-left border-separate border-spacing-y-3">
                    <thead>
                        <tr className="text-[10px] font-bold uppercase tracking-widest text-slate-300">
                        ...
                        {pages.length === 0 && !loading && (
                            <tr>
                                <td colSpan={4} className="px-6 py-20 bg-[#f8fafc] rounded-3xl text-center border border-dashed border-border">
                                    ...
                                    <p className="text-sm font-bold text-slate-300 uppercase tracking-widest">No pages created yet</p>
                                </td>
                            </tr>
                        )}
                        {loading && (
                                ...
                                <td className="px-6 py-5 rounded-l-2xl border-l border-y border-transparent group-hover/tr:border-slate-100">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="space-y-0.5">
                                            ...
                                            <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">INDEX: {i + 1}</p>
                                        </div>
                                    </div>
                                </td>
                                <td className="px-6 py-5 border-y border-transparent group-hover/tr:border-slate-100">
                                    <code className="px-3 py-1 bg-white rounded-lg border border-slate-100 text-[11px] font-bold text-[#14532d]/60 uppercase tracking-tight">/{p.slug}</code>
                                </td>
                                <td className="px-6 py-5 text-center border-y border-transparent group-hover/tr:border-slate-100">
                                    <span className={cn(
                                        "px-4 py-1.5 rounded-full font-bold uppercase text-[9px] tracking-widest shadow-sm border",
            ...
            <DynamicFormDialog
                ...
                title={editingPage ? "Refine Page Content" : "Construct New Page"}
                fields={fields}
            ...
            <div className="mt-12 flex items-center justify-between opacity-40 group-hover:opacity-100 transition-opacity">
                <div className="flex items-center gap-4">
                    ...
                    <p className="text-[10px] font-bold uppercase tracking-widest text-[#14532d]">Content Integrity Active</p>
                </div>
                <div className="flex items-center gap-2">
                    <Zap className="w-4 h-4 text-[#f97316] animate-pulse" />
                    <span className="text-[10px] font-bold uppercase tracking-widest text-slate-400">Synced to cloud storage</span>
                </div>
            </div>
        </div>
    );
