        ...
        { 
            ...
            render: (row: any) => (
                <div className="flex flex-col">
                    ...
                    <span className="text-xs text-gray-400 font-bold  tracking-widest mt-1">Shipment Target</span>
                </div>
            )
        },
        { 
            ...
            render: (row: any) => row.tracking_number ? (
                <div className="flex items-center gap-2 group">
                    <span className="text-[13px] font-bold text-indigo-600  tracking-widest">{row.tracking_number}</span>
                    <ExternalLink className="w-3 h-3 text-slate-300 group-hover:text-indigo-400 transition-colors" />
                </div>
            ) : (
                <span className="text-xs font-bold text-slate-300  tracking-widest">Awaiting Scan</span>
            )
        },
        { 
            key: "status", 
