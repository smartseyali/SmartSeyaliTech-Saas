                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between mb-24 gap-12 border-b border-slate-100 pb-16">
                    <div className="space-y-6">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-slate-500 font-bold  tracking-widest text-xs ">Order Management</span>
                        </div>
                    ...
                    <div className="flex flex-col md:items-end gap-6 text-right">
                        <p className="text-lg text-slate-500 font-medium  md:text-right max-w-sm leading-relaxed">
                            Complete history of your professional acquisitions and service deployments.
                        </p>
                        <Link
                            to={storeLink("/shop")}
                            className="text-xs font-bold  tracking-widest text-blue-600 hover:text-slate-900 transition-all border-b-2 border-slate-100 hover:border-blue-600 pb-2 "
                        >
                            Back to Store
                        </Link>
                    </div>
                ...
                {loading ? (
                    ...
                    <div className="max-w-3xl mx-auto text-center py-48 space-y-12 bg-white rounded-[5rem] border border-slate-50 shadow-2xl shadow-slate-200/30">
                        ...
                        <div className="space-y-4">
                            ...
                            <p className="text-slate-500 font-medium  px-24 text-lg">Your account history contains no recorded purchases at this time.</p>
                        </div>
                        <Button
                            onClick={() => navigate(storeLink("/shop"))}
                            className="h-20 px-16 rounded-3xl bg-blue-600 text-white font-bold  tracking-widest text-[13px] shadow-2xl shadow-blue-600/30 transition-all border-none  hover:bg-slate-900"
                        >
                            Start Shopping
                        </Button>
                    </div>
                                    ...
                                    <div className="space-y-12 relative z-10">
                                        <div className="flex justify-between items-start gap-4">
                                            <div className="space-y-2">
                                                <p className="text-xs font-bold  tracking-widest text-slate-300  leading-none">ORDER_ID</p>
                                            ...
                                            <div className={cn("px-6 py-2.5 rounded-2xl border font-bold  text-[13px] tracking-widest shadow-2xl ", getStatusStyles(order.status))}>
                                                {order.status}
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex flex-col gap-8 py-10 border-y border-slate-50">
                                            <div className="flex items-center gap-6">
                                                ...
                                                <div className="space-y-1">
                                                    <span className="text-[13px] font-bold  tracking-widest text-slate-900 ">{new Date(order.created_at).toLocaleDateString()}</span>
                                                    <p className="text-xs font-bold text-slate-300  tracking-widest  leading-none opacity-60">Confirmed Date</p>
                                                </div>
                                            </div>
                                            <div className="flex items-center gap-6">
                                                <div className="w-12 h-12 rounded-2xl bg-slate-50 flex items-center justify-center text-blue-600 border border-slate-100 group-hover:bg-blue-600 group-hover:text-white transition-all shadow-inner">
                                                ...
                                                <div className="space-y-1">
                                                    <span className="text-[13px] font-bold  tracking-widest text-slate-900 ">{order.items?.length || 1} Products</span>
                                                    <p className="text-xs font-bold text-slate-300  tracking-widest  leading-none opacity-60">Verified Assets</p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex justify-between items-end">
                                            <div className="space-y-3">
                                                <p className="text-xs font-bold  tracking-widest text-blue-500  leading-none">Total Amount</p>
                ...
                <div className="p-20 bg-white rounded-[5rem] border border-slate-50 flex flex-col md:flex-row items-center justify-between gap-12 shadow-2xl shadow-slate-200/20">
                    <div className="flex items-center gap-10 group">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-xs font-bold text-slate-300  tracking-widest  leading-none opacity-60">Verified Operational Protocol</p>
                        </div>
                    </div>
                    <div className="flex items-center gap-4 text-slate-200 px-12 py-6 bg-slate-50 rounded-full border border-slate-100 shadow-inner">
                        ...
                        <span className="text-xs font-bold  tracking-[1em] ">System Verified</span>
                    </div>
                </div>
            </div>
        </div>
