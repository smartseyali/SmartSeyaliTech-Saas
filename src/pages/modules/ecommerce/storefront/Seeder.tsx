                ...
                <div className="bg-white rounded-[48px] p-16 text-center space-y-10 shadow-2xl border border-slate-100 relative overflow-hidden">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center justify-center gap-2">
                            ...
                            <span className="text-[10px] font-black uppercase tracking-[0.4em] text-[#14532d]/40">System Utility</span>
                        </div>
                        <h1 className="text-4xl md:text-5xl font-black text-[#14532d] uppercase tracking-tighter leading-none">Market <br /> <span className="text-[#f97316]">Nurturer</span></h1>
                        <p className="text-slate-400 font-medium italic text-sm">Populate your registry with sample organic specimens for testing.</p>
                    </div>

                    <div className="p-8 bg-[#fafaf9] rounded-3xl border border-dashed border-slate-200 text-[10px] font-black uppercase tracking-widest text-[#14532d]/60 leading-relaxed italic">
                    ...
                    <Button
                        onClick={seed}
                        disabled={loading}
                        className="w-full h-16 rounded-2xl bg-[#14532d] hover:bg-[#14532d]/90 text-white font-black uppercase tracking-widest text-[10px] shadow-2xl shadow-[#14532d]/20 transition-all"
                    >
