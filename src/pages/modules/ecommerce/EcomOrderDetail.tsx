                ...
                <div className="flex items-center gap-8">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-xs font-black uppercase tracking-[0.3em] text-slate-500 italic">Order Details</span>
                        </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
                <div className="lg:col-span-8 space-y-12">
                    <div className="bg-white rounded-[40px] border border-slate-100 shadow-sm overflow-hidden hover:shadow-2xl transition-all duration-500">
                        <div className="px-10 py-8 border-b border-slate-50 bg-white flex items-center justify-between relative">
                            ...
                            <span className="text-[10px] font-black text-blue-600 bg-blue-50 px-5 py-2 rounded-2xl uppercase tracking-[0.2em] border border-blue-100">{items.length} Items</span>
                        </div>
                                                ...
                                                <div className="flex items-center gap-6">
                                                    ...
                                                    <div className="space-y-2">
                                                        ...
                                                        <div className="flex items-center gap-3">
                                                            ...
                                                            <span className="text-[10px] text-slate-500 font-bold uppercase tracking-[0.3em] font-mono">#{item.sku}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
                        ...
                        <div className="p-12 space-y-6 bg-slate-900 border-t border-slate-100 text-white relative overflow-hidden group">
                            ...
                            <div className="flex justify-between items-end pt-10 relative z-10">
                                <div className="space-y-3">
                                    <span className="text-[11px] font-black uppercase tracking-[0.5em] text-blue-500 animate-pulse">Grand Total</span>
                                    <p className="text-[10px] text-slate-500 font-bold uppercase tracking-widest italic opacity-50">Inclusive of all taxes</p>
                                </div>
                            ...
                            <div>
                                ...
                                <div className="space-y-8">
                                    <div className="space-y-4 group/field">
                                        <label className="text-[9px] font-black uppercase tracking-[0.3em] text-slate-400 ml-1 group-focus-within/field:text-blue-600 transition-colors">Courier Partner</label>
                                    ...
                                    <div className="space-y-4 group/field">
                                        <label className="text-[9px] font-black uppercase tracking-[0.3em] text-slate-400 ml-1 group-focus-within/field:text-blue-600 transition-colors">Tracking Number (AWB)</label>
                        ...
                        <div className="bg-white rounded-[40px] border border-slate-100 p-10 shadow-sm hover:shadow-2xl transition-all duration-500">
                            ...
                            {timeline.length === 0 ? (
                                <div className="text-center py-20 bg-slate-50/30 rounded-[32px] border border-dashed border-slate-200">
                                    ...
                                    <p className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-300 italic">No events found</p>
                                </div>
                            ) : (
                                        ...
                                        return (
                                            <div key={t.id} className="relative group/ev">
                                                ...
                                                <div className="space-y-2">
                                                    ...
                                                    <p className="text-[9px] font-bold text-slate-500 uppercase tracking-[0.2em] italic font-mono">
                ...
                <div className="lg:col-span-4 space-y-12">
                    ...
                    <div className="bg-slate-950 rounded-[48px] p-12 text-white shadow-2xl relative overflow-hidden group">
                        ...
                        <h2 className="text-[10px] font-black uppercase tracking-[0.4em] text-blue-500 mb-12 relative z-10 italic">Customer Details</h2>
                        ...
                        <div className="flex flex-col items-center text-center mb-12 relative z-10">
                            ...
                            <div className="inline-flex items-center px-4 py-1.5 rounded-full bg-blue-600/20 text-blue-400 text-[9px] font-black uppercase tracking-[0.2em] border border-blue-500/30">Verified Customer</div>
                        </div>
                        ...
                        <div className="space-y-6 relative z-10">
                            <div className="flex items-center gap-6 p-6 rounded-[28px] bg-white/5 hover:bg-white/10 transition-all border border-white/5 group/row">
                                ...
                                <span className="text-base font-black tracking-tight text-white/90 font-mono">{order.customer_phone || "Not provided"}</span>
                            </div>
                            <div className="flex items-center gap-6 p-6 rounded-[28px] bg-white/5 hover:bg-white/10 transition-all border border-white/5 group/row">
                                <div className="w-12 h-12 rounded-2xl bg-white/5 flex items-center justify-center text-white/20 group-hover/row:bg-blue-600 group-hover/row:text-white transition-all">
                                    <Mail className="w-5 h-5" />
                                </div>
                                <span className="text-sm font-black tracking-tight text-white/90 truncate">{order.customer_email || "No Email"}</span>
                            </div>
                        </div>
                        ...
                        {addr.line1 && (
                            <div className="mt-12 pt-12 border-t border-white/10 relative z-10">
                                <div className="flex items-center gap-4 mb-8">
                                    ...
                                    <h3 className="text-[10px] font-black uppercase tracking-[0.4em] text-white/30 italic">Delivery Address</h3>
                                </div>
                    ...
                    <div className="bg-white rounded-[48px] border border-slate-100 p-10 shadow-sm hover:shadow-2xl transition-all duration-500">
                        ...
                        <div className="space-y-10">
                            <div className="p-10 rounded-[40px] bg-slate-50 border border-slate-100 shadow-inner group/bill">
                                <div className="flex justify-between items-center mb-10">
                                    <div className="space-y-1">
                                        <span className="text-[9px] font-black uppercase tracking-[0.3em] text-slate-400 block">Payment Method</span>
                                        <span className="text-[10px] font-black uppercase tracking-[0.2em] px-5 py-2 bg-white rounded-xl border border-slate-200 text-slate-950 shadow-sm">{order.payment_method || "COD"}</span>
                                    </div>
                                    <div className="space-y-1 text-right">
                                        <span className="text-[9px] font-black uppercase tracking-[0.3em] text-slate-400 block">Status</span>
                                        <span className={cn(
                                ...
                                <div className="flex flex-col items-center pt-10 border-t border-slate-200/60">
                                    <span className="text-[11px] font-black text-slate-400 uppercase tracking-[0.5em] mb-4">Total Amount</span>
                            ...
                            {order.payment_gateway_ref && (
                                <div className="space-y-4">
                                    <label className="text-[9px] font-black uppercase tracking-[0.4em] text-slate-400 ml-1">Payment Reference ID</label>
