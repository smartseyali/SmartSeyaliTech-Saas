...
export default function PaymentGateways() {
    ...
    if (loading) return (
        <div className="h-[60vh] flex items-center justify-center flex-col gap-4">
            ...
            <p className="font-bold text-xs  tracking-widest text-slate-500">Loading Payment Gateways...</p>
        </div>
    );
    ...
    return (
        <div className="p-8 space-y-8 animate-in fade-in duration-500 pb-20">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-8 border-b border-slate-100">
                <div>
                    <p className="text-xs font-bold  tracking-widest text-slate-500 mb-1">Financial</p>
                        ...
                        <div key={key} className={cn(
                            ...
                            <div className="p-10 space-y-8">
                                <div className="flex items-start justify-between">
                                    <div className="flex gap-6">
                                        ...
                                        <div>
                                            ...
                                            {meta.docsUrl && (
                                                <a href={meta.docsUrl} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-3 py-1 bg-slate-50 text-[13px] font-bold text-blue-600  tracking-widest mt-4 rounded-lg border border-slate-100 hover:bg-white transition-all">
                                ...
                                <div className="flex flex-wrap gap-3">
                                    <div className={cn(
                                        "px-4 py-1.5 rounded-full text-[13px] font-bold  tracking-widest flex items-center gap-2 border shadow-sm",
                                    ...
                                    {isActive && key !== "cod" && (
                                        <button
                                            ...
                                            className={cn(
                                                "px-4 py-1.5 rounded-full text-[13px] font-bold  tracking-widest transition-all border shadow-sm flex items-center gap-2",
                                    ...
                                    <div className="pt-5 border-t border-slate-100 flex items-center justify-between gap-3">
                                        ...
                                        {key !== 'cod' && (
                                            <Button
                                                ...
                                                className="h-9 px-4 rounded-xl font-semibold text-sm gap-2 text-slate-500 hover:text-blue-600 transition-all"
                                            >
                                                ...
                                                <div className="relative">
                                                    ...
                                                    {field.type === "password" && (
                                                        <button type="button"
                                                            ...
                                                            className="absolute right-3.5 top-1/2 -translate-y-1/2 text-slate-500 hover:text-blue-600 transition-colors"
                                                        >
