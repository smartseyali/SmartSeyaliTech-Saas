...
export default function EmployeeInduction() {
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="flex items-center gap-2 mt-0.5">
                            <span className="text-xs text-indigo-600 font-bold  tracking-widest leading-none bg-indigo-50 px-2 py-0.5 rounded border border-indigo-100">
            ...
            render: (inc: any) => (
                <div className="flex flex-col">
                    <div className="flex items-center justify-between mb-1.5 w-32">
                        <span className="text-xs font-bold text-slate-500  tracking-widest">Task Nodes</span>
                        <span className="text-xs font-bold text-slate-900  tracking-widest">{inc.completed_tasks || 2} / {inc.total_tasks || 8}</span>
                    </div>
    ...
    return (
        <ERPListView
            ...
            headerActions={
                <div className="flex items-center gap-2">
                    <button className="h-8 px-4 rounded-xl font-bold text-xs  tracking-widest bg-emerald-50 text-emerald-600 border border-emerald-100 hover:bg-emerald-100 transition-all shadow-sm flex items-center gap-2">
