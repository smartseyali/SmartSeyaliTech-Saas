        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="max-w-3xl">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 leading-[1.1] tracking-tight mb-6">
              Privacy<br /><span className="text-primary-600">Policy</span>
            </h1>
            <p className="text-lg text-gray-500 leading-relaxed max-w-2xl mb-6">
              How {COMPANY} collects, uses, and protects your personal information when you use the SmartSeyali business platform.
            </p>
          ...
          >
            <div className="bg-white border border-gray-100 rounded-2xl p-6">
              ...
              <div className="mt-6 pt-5 border-t border-gray-100">
                <Link href="/terms" className="flex items-center gap-2 text-xs text-gray-500 hover:text-primary-600 transition-colors group">
          ...
          <div className="flex-1 min-w-0 space-y-6">
            <SectionBlock id="information" number="01" icon={Eye} title="Information We Collect">
              <SubSection title="a) Account & Identity Information">
                <Ul items={["Full name, email address, and password (hashed)", "Profile avatar and username",
                  "Phone number (optional)", "Multi-factor authentication credentials"]} />
              </SubSection>
              <SubSection title="b) Business & Company Data">
                <Ul items={["Company name, address, city, state, country, and pincode",
                  "GSTIN and other tax identification numbers", "Company logo and branding assets",
                  "Industry type and business category"]} />
              </SubSection>
              <SubSection title="c) Operational Data">
                <Ul items={["Product catalogs, orders, invoices, and inventory records",
              ...
              <SubSection title="d) Automatically Collected Information">
                <Ul items={["IP address, browser type, and operating system",
                  "Pages visited, actions performed, and session duration",
                  "Device identifiers and timezone", "Error logs and performance diagnostics"]} />
              </SubSection>
            </SectionBlock>

            <SectionBlock id="use" number="02" icon={Database} title="How We Use Your Information">
              <Ul items={["To create and manage your account and company workspace",
            ...
            <SectionBlock id="sharing" number="03" icon={Users} title="Data Sharing & Disclosure">
              ...
              <Ul items={["Supabase Inc. — our cloud database and authentication provider",
              ...
              <p className="mt-3 text-xs text-gray-400">All third-party providers are bound by data processing agreements consistent with applicable privacy laws.</p>
            </SectionBlock>

            <SectionBlock id="cookies" number="04" icon={Globe} title="Cookies & Tracking Technologies">
              <p>We use cookies and similar technologies for:</p>
              <Ul items={["Session management — keeping you logged in securely",
              ...
              <p className="mt-3">You can disable cookies in your browser settings, but this may affect platform functionality. We do not use third-party advertising cookies.</p>
            </SectionBlock>
            ...
            <SectionBlock id="security" number="05" icon={Lock} title="Data Storage & Security">
              ...
              <Ul items={["TLS 1.3 encryption for all data in transit", "AES-256 encryption for data at rest",
                "Row-level security policies enforced at the database layer",
                "Multi-factor authentication (TOTP) available for all accounts",
                "Session timeouts and token rotation", "Access logs and audit trails",
            ...
            <SectionBlock id="retention" number="06" icon={RefreshCw} title="Data Retention">
              ...
              <Ul items={["Account data — retained for the lifetime of your account",
              ...
              <p className="mt-3">Upon account deletion, personal data is removed within 30 days, except where retention is required by law.</p>
            </SectionBlock>
            ...
            <SectionBlock id="rights" number="07" icon={Shield} title="Your Rights">
              ...
              <Ul items={["Access — request a copy of your personal data we hold",
              ...
              <p className="mt-3">
                To exercise these rights, email <a href={`mailto:${SUPPORT_EMAIL}`} className="text-primary-600 underline">{SUPPORT_EMAIL}</a> with subject line &quot;Privacy Request&quot;. We respond within 30 days.
              </p>
            </SectionBlock>
            ...
            <SectionBlock id="third-party" number="08" icon={Globe} title="Third-Party Services">
              ...
              <Ul items={["Supabase — Database & Authentication: supabase.com/privacy",
              ...
              <p className="mt-3">We are not responsible for the privacy practices of third-party services. We recommend reviewing their policies.</p>
            </SectionBlock>

            <SectionBlock id="children" number="09" icon={Users} title="Children's Privacy">
              <p>
                {COMPANY}&apos;s platform is a business-to-business (B2B) service intended exclusively for organisations and individuals aged 18 and above. We do not knowingly collect personal information from minors. If you believe a minor has created an account, contact us immediately at <a href={`mailto:${SUPPORT_EMAIL}`} className="text-primary-600 underline">{SUPPORT_EMAIL}</a> and we will delete the account promptly.
              </p>
            </SectionBlock>

            <SectionBlock id="changes" number="10" icon={RefreshCw} title="Policy Changes">
              <p>We may update this Privacy Policy periodically to reflect changes in our practices, technology, or legal requirements. When we make material changes:</p>
              ...
              <p className="mt-3">Continued use of the platform after the effective date constitutes acceptance of the updated policy.</p>
            </SectionBlock>
            ...
            <motion.div {...fadeUp()} className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-4">
              ...
              <Link href="/terms" className="inline-flex items-center gap-2 text-sm font-semibold text-primary-600 hover:underline">
                Read our Terms & Conditions<ArrowRight className="w-4 h-4" />
              </Link>
            </motion.div>
          </div>
        </div>
