                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-12">
                        {[
                            ...
                            <div key={item.label} className="flex items-center gap-5">
                                ...
                                <div>
                                    <p className="text-[13px] font-bold text-white uppercase tracking-widest leading-none ">{item.label}</p>
                                    <p className="text-xs text-slate-500 font-bold uppercase tracking-wider mt-1.5 ">{item.sub}</p>
                                </div>
                            </div>
                        ))}
                    </div>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-5 gap-16">
                    ...
                    <div className="col-span-2 md:col-span-1 space-y-8">
                        <div className="space-y-3">
                            ...
                            <span className="text-xs font-bold uppercase tracking-widest text-blue-500 ">Corporate Office</span>
                        </div>
                    ...
                    <div className="space-y-6">
                        <h5 className="text-[13px] font-bold text-slate-500 uppercase tracking-widest mb-8 ">Company</h5>
                        <div className="space-y-4">
                            {[
                                ...
                                <div key={l.label}><Link to={storeLink(l.path)} className="text-[13px] font-bold text-slate-500 hover:text-white transition-colors uppercase tracking-widest ">{l.label}</Link></div>
                            ))}
                        </div>
                    </div>

                    <div className="space-y-6">
                        <h5 className="text-[13px] font-bold text-slate-500 uppercase tracking-widest mb-8 ">Support</h5>
                        <div className="space-y-4">
                            {[
                    ...
                    <div className="space-y-6">
                        <h5 className="text-[13px] font-bold text-slate-500 uppercase tracking-widest mb-8 ">Legal</h5>
                        <div className="space-y-4">
                            {[
                                "Terms of Service",
                                "Privacy Policy",
                                ...
                                <div key={l}><Link to="#" className="text-[13px] font-bold text-slate-500 hover:text-white transition-colors uppercase tracking-widest ">{l}</Link></div>
                            ))}
                        </div>
                    </div>
                    ...
                    <div className="space-y-8">
                        <h5 className="text-[13px] font-bold text-slate-500 uppercase tracking-widest mb-8 ">Payments</h5>
                        <div className="grid grid-cols-2 gap-2">
                            {["UPI", "RuPay", "Visa", "MC", "NB", "COD"].map(p => (
                                <div key={p} className="bg-white/5 rounded-lg px-2 py-2 text-center border border-white/5">
                                    <span className="text-xs font-bold text-slate-500 tracking-widest ">{p}</span>
                                </div>
                            ))}
                        </div>
                        <div className="pt-4 space-y-4">
                            <h5 className="text-[13px] font-bold text-slate-500 uppercase tracking-widest ">Mobile Access</h5>
                            {[
                                ...
                                <a key={a.label} href="#" className="flex items-center gap-4 bg-white/5 hover:bg-white/10 rounded-2xl px-6 py-4 transition-all border border-white/5 group">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[13px] font-bold text-white uppercase tracking-widest ">{a.label}</p>
                                    </div>
                                </a>
                            ))}
                        </div>
                ...
                <div className="max-w-screen-xl mx-auto px-6 md:px-12 py-8 flex flex-col md:flex-row items-center gap-6 justify-between">
                    ...
                    <div className="flex items-center gap-8 flex-wrap justify-center">
                        {["Terms", "Privacy", "Security", "Ethics"].map(item => (
                            <Link key={item} to="#" className="text-xs font-bold text-slate-600 hover:text-blue-500 transition-colors uppercase tracking-widest ">{item}</Link>
                        ))}
                    </div>
                </div>
            </div>
