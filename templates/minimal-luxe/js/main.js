...
(function () {
    ...
    window.StorefrontInstance = {
        ...
        async init() {
            ...
            const slug = "minimal-luxe"; // __TENANT_SLUG__
        ...
        applyBranding(data) {
            document.title = `${data.name || 'MUSE'} | Essential Elegance`;
            ...
            if (data.primary_color) {
                document.documentElement.style.setProperty('--p-900', data.primary_color);
            }
        },
        ...
        addToCart(product, qty = 1) {
            ...
            this.saveCart();
            this.pushNotification(`${product.name} ADDED TO COLLECTION.`);
        },
